# caissiers_api/serializers.py
from rest_framework import serializers
from .models import Caissier

class CaissierSerializer(serializers.ModelSerializer):
    """
    Serializer pour le modèle Caissier, incluant les détails de l'Agent et de l'Utilisateur.
    """
    ...
    class Meta:
        model = Caissier
        fields = (
            'matricule_caissier', 'agent_code', 'email', 'first_name', 
            'last_name', 'is_trained', 'is_active'
        )
